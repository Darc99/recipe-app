...
public class RecipeToRecipeCommand implements Converter<Recipe, RecipeCommand> {
    ...
    public RecipeToRecipeCommand(CategoryToCategoryCommand categoryConverter, IngredientToIngredientCommand
            ingredientConverter, NotesToNotesCommand notesConverter) {
